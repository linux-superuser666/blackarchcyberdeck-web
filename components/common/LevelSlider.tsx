...
const LevelSlider = () => {
  ...
  return (
    <div
      className="w-32 h-3 z-[90] [clip-path:polygon(0_0,_100%_0,_100%_75%,_96%_100%,_0_100%)] bg-redx/30 p-px relative flex items-center justify-center"
      ...
      <div className="size-full [clip-path:polygon(0_0,_100%_0,_100%_75%,_96%_100%,_0_100%)] bg-black flex flex-row gap-1 items-center justify-between p-px">
        ...
        <div ref={trackRef} className="relative z-[99] w-full h-full">
          ...
          <div
            ...
            className="bg-redx/50 w-4 absolute top-0 h-2.5 [clip-path:polygon(100%_0,_100%_67%,_72%_100%,_0_100%,_0_0)] cursor-pointer flex pt-px items-center text-greyx justify-center text-[7px]"
          >
            {value}
          </div>
        </div>
