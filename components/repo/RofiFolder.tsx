...
const RofiFolder: React.FC = () => {
  const [items, setItems] = useState<{ name: string; type: string }[]>([]);

  useEffect(() => {
    async function fetchData() {
      const res = await fetch(
        "https://api.github.com/repos/linux-superuser666/BlackArchCyberpunk2077/contents/rofi"
      );
        ...
        >
          <div className="grid grid-cols-[56px] grid-rows-[64px_1fr] h-20 w-14 gap-0 relative p-px">
            {item.type === "dir" ? (
              ...
              <div className="h-full w-[48px] bg-redx/30 p-px [clip-path:polygon(9%_36%,_52%_10%,_36%_14%,_45%_5%,_34%_8%,_43%_0,_0_0,_0_50%,_49%_21%,_0_56%,_27%_41%,_0_63%,_0_100%,_16%_100%,_71%_47%,_23%_100%,_56%_100%,_84%_69%,_60%_100%,_83%_100%,_100%_83%,_100%_0,_75%_0)]">
